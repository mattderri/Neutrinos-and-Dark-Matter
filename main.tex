...
\usepackage{subfig}
\usepackage{pgfplots}
% \newcommand{\begin{mybox}}[1]{\begin{tcolorbox}[width=\textwidth,colback={black!40},title={#1},colbacktitle={purple!55},coltitle=black]}
% \renewcommand{\end{mybox}\noindent}{\end{tcolorbox}\noindent}
...
\begin{mybox}
\textbf{Hubble Constant{\color{blue!30}{g}}}
\hrule
\[
...
\begin{mybox}
\textbf{Hubble Time {\color{blue!30}{g}}}
\hrule
\[
...
\begin{mybox}
\textbf{Redshift{\color{blue!30}{g}}}
\hrule
\[
Z=H_0(t_0-t_{\text{e}})
\]
...
\begin{mybox}
\textbf{Friedmann Equation (classical derivation)}
\hrule
\[
...
\begin{mybox}
\textbf{Friedmann Equation (relativistic version)}
\hrule
\[
...
\begin{mybox}
\textbf{Full Metal Friedmann Equation}
\hrule
\[
...
\begin{mybox}
\textbf{Navarro-Frenk-White Model{color{blue!30}{g}}}
\hrule
\[
...
We then get:
\begin{mybox}
\textbf{Upper Limit on Neutrino Mass}
\hrule
\[
...
\begin{mybox}
\textbf{Oscillation Probability in the Vacuum}
\hrule
\begin{align*}
...
\begin{mybox}
\textbf{Oscillation Probability in Matter}
\hrule
\[
...
\begin{mybox}
\textbf{KamLAND Results{\color{blue!30}{g}}}
\hrule
\[
...
% \begin{tikzpicture}
% \begin{axis}[
% xmin=-10, xmax=90, ymin=-0.4, ymax=1,
% xlabel=$(\frac{W}{S})_{TO}$,
% ylabel=$(\frac{T}{W})_{TO}$,
% title={boh }]
% \addplot[domain=-10:90, color=red]{x/167};
% \addplot[domain=-10:90, color=blue]{x/189};
% \addplot[domain=-10:90, color=green]{x/210};
% \addplot[domain=-10:90, color=orange]{x/231};
% \end{axis}
% \end{tikzpicture}
% \begin{center}
% \begin{tikzpicture}
...
%   \draw[-] (-10,-0.4) -- (90,-0.4) node[right] {$a$};
%   \draw[-] (-10,1) -- (90,1) node[right] {$a$};
%   \draw[-] (0,-0.4) -- (0,1) node[above] {$T$};
%   \draw[-] (90,-0.4) -- (90,1) node[above] {$T$};
