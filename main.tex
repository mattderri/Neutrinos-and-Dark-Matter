...
\[
\varepsilon=\int dt\Ddot{R}(t)\Dot{R}(t)=\int d\Dot{R}\Dot{R}(t)=\frac{\Dot{R}^2(t)}{2}
\]
...
\]
where the index $i$ is the one for the three families $e,\mu,\tau$. 
\beginbox{Density of Neutrinos}
\[
T_{0,\nu}=1.05\,\text{K}\quad n_{\nu}\approx3.4\cdot10^8\,\text{m$^{-3}$}
\]
\endbox
